...
export type AdminDataQuery = { __typename?: 'Query', adminData: { __typename?: 'AdminData', totalUsersSavings: Array<{ __typename?: 'DateData', month: number, year: number, value: number }>, totalActiveUsers: Array<{ __typename?: 'DateData', month: number, year: number, value: number }>, totalUsers: Array<{ __typename?: 'DateData', month: number, year: number, value: number }>, newUsers: Array<{ __typename?: 'DateData', month: number, year: number, value: number }>, userAnnualIncomeStats: Array<{ __typename?: 'NameData', name: string, value: number }>, userLiabilitiesStats: Array<{ __typename?: 'NameData', name: string, value: number }>, userMonthlyExpenseStats: Array<{ __typename?: 'NameData', name: string, value: number }> } };
...
export type UserQuery = { __typename?: 'Query', user: { __typename?: 'User', id: string, email: string, username: string, phone: string, birth_year: number, experience: number, createdAt: any, updatedAt: any, wallet_id: string, news_topics_followed: Array<NewsTopic>, wallet: { __typename?: 'Wallet', id: string, createdAt: any, updatedAt: any, transactions: Array<{ __typename?: 'Transaction', id: string, amount: number, wallet_id: string, financial_goal: { __typename?: 'FinancialGoal', name: string } }> }, financial_goal: Array<{ __typename?: 'FinancialGoal', id: string, userId: string, emoji: string, name: string, amount: number, months_to_reach_goal: number, createdAt: any, updatedAt: any }>, user_info?: { __typename?: 'UserInfo', createdAt: any } | null } };
...
export type UserInfoQuery = { __typename?: 'Query', user: { __typename?: 'User', username: string, user_info?: { __typename?: 'UserInfo', userId: string, annual_income: AnnualIncome, estimated_liabilities: EstimatedLiabilities, estimated_monthly_expenses: EstimatedMonthlyExpenses, invested_before: boolean, risk_tolerance: RiskTolerance, expected_annual_return: ExpectedAnnualReturn, investment_horizon: InvestmentHorizon, createdAt: any, updatedAt: any } | null } };
...
export const AiStrategyDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AiStrategy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"aiStrategy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"expensesRatio"}},{"kind":"Field","name":{"kind":"Name","value":"turnoverRatio"}},{"kind":"Field","name":{"kind":"Name","value":"unitTrustFundRecommendations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"fundName"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"expenseRatio"}},{"kind":"Field","name":{"kind":"Name","value":"turnoverRatio"}},{"kind":"Field","name":{"kind":"Name","value":"riskLevel"}},{"kind":"Field","name":{"kind":"Name","value":"phsUrl"}}]}}]}}]}}]} as unknown as DocumentNode<AiStrategyQuery, AiStrategyQueryVariables>;
