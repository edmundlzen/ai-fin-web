...
export type UserNewsIndexQueryVariables = Exact<{ [key: string]: never; }>;


export type UserNewsIndexQuery = { __typename?: 'Query', News: Array<{ __typename?: 'News', author?: string | null, title: string, description: string, url: string, urlToImage?: string | null, publishedAt: string, content: string, source: { __typename?: 'NewsSource', id?: string | null, name: string } }> };
